...
public class Sensordeproximidad extends AppCompatActivity {
    ...
    Sensor sensor;
    // para determinar fsi algo de acerca al dispositivo
    SensorEventListener sensorEventListener;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sensordeproximidad);
...
// llamamos al evento Listener para determinar determinar los cambios
    ...
    // Estos dos métodos se agregaron haciendo clic derecho en este punto // y buscando en la lista de métodos estos
    @Override
